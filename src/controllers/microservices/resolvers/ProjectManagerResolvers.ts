                ...
                async getGeneralTimelineEvents(root) {
                    ...
                    await new Promise((resolve, reject) => {
                        ...
                        buffer.forEach(async (ev, ind) => {
                            ...
                            await knexConnection.raw('SELECT id_subprojects_updates, fk_projects_subprojects_subprojects_updates, fk_subproject_updates_approval_user, updates_approval_user_facts, fk_subproject_updates_emit_user, fk_subproject_updates_emit_user_facts, status, approval_user_decision, created_at, finished_at, fk_vision_timeline_event_subproject_updates FROM visioncenter_subprojects_events WHERE fk_vision_timeline_event_subproject_updates = '+ev.id_timeline_events+' ORDER BY id_subprojects_updates DESC').then(function(subprojects_events) {
